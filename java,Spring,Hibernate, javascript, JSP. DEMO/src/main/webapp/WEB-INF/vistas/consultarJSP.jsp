<%-- 
    Document   : consultarJSP
    Created on : 09-ago-2019, 17:53:03
    Author     : Lain
--%>
...
<html>
    ...
    <body>
        <div id="center">
        <h1>Ingrese el codigo identificador del producto que desea consultar</h1>
        <form action="ctrlSecundario/consultar" id="validar">
