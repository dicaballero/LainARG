...
public class productoRepository {
    ...
    public static Object createProducto(String s, int i, int ii, double d) {
        ...
        if(p.getId()==i){
        return "Create Producto: El producton con id="+i+" , ya existe!";    
        }
        }
    ...
    public static Object readProducto(int i) {
        ...
        return "Read producto: El producto con id="+i+", no fue encontrado";
    }
    ...
    public static Object deleteProducto(int i) {
        ...
        return "Delete producto: El producto con id="+i+", no fue encontrado";
    }
    ...
    public static Object updateProducto(String s, int i, int ii, double d){
        ...
        return "Update producto: El producto con id="+i+", no fue encontrado";
    }
